...
module.exports = {
  ...
  resolve: {
    ...
    alias: {
      ...
      'react-spinners': path.resolve(__dirname, '../node_modules', 'react-spinners'),
      'react-split-pane': path.resolve(__dirname, '../node_modules', 'react-split-pane'),
      'redux-undo': path.resolve(__dirname, '../node_modules', 'redux-undo'),
    },
    plugins: [
